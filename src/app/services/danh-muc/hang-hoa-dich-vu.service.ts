...
export class HangHoaDichVuService {
  public apiURL = this.env.apiUrl + '/api/HangHoaDichVu';
  ...
  ImportVTHH(data: any) {
    return this.http.post(`${this.apiURL}/ImportVTHH`, data, getHeader());
  }
  InsertVTHHImport(data: any) {
    return this.http.post(`${this.apiURL}/InsertVTHHImport`, data, getHeader());
  }
  CreateFileImportVTHHError(data: any) {
    return this.http.post(`${this.apiURL}/CreateFileImportVTHHError`, data, getHeader());
  }
}
