...
export class ThongBaoPhatHanhService {
  public apiURL = this.env.apiUrl + '/api/ThongBaoPhatHanh';

  constructor(
    private http: HttpClient,
    private env: EnvService) { }

  GetCacLoaiHoaDonPhatHanhs(id: string) {
    return this.http.get(`${this.apiURL}/GetCacLoaiHoaDonPhatHanhs?Id=` + id, getHeader());
  }

  GetTrangThaiNops() {
    return this.http.get(`${this.apiURL}/GetTrangThaiNops`, getHeader());
  }
  ...
  GetThongBaoPhatHanhChiTietById(id: string) {
    return this.http.get(`${this.apiURL}/GetThongBaoPhatHanhChiTietById/` + id, getHeader());
  }

  GetListChiTietThongBaoPhatHanhByMauHoaDonId(id: string) {
    return this.http.get(`${this.apiURL}/GetListChiTietThongBaoPhatHanhByMauHoaDonId/` + id, getHeader());
  }

  CheckAllowUpdateDelete(id: any) {
    return this.http.get(`${this.apiURL}/CheckAllowUpdateDelete/` + id, getHeader());
  }
  ...
  GetTuSoTiepTheo(data: any) {
    return this.http.post(`${this.apiURL}/GetTuSoTiepTheo`, data, getHeader());
  }
}
