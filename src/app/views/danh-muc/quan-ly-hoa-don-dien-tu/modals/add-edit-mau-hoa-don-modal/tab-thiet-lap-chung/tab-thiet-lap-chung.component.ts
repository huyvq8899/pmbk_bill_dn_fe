...
import { getNgonNgus, isValidExtention, isValidFileSize, setStyleTooltipError } from 'src/app/shared/SharedFunction';
import { GetRawTuyChinhChiTiet } from 'src/assets/ts/init-create-mau-hd';
import { map } from 'rxjs/operators';

@Component({
  selector: 'app-tab-thiet-lap-chung',
  templateUrl: './tab-thiet-lap-chung.component.html',
  styleUrls: ['./tab-thiet-lap-chung.component.scss']
})
export class TabThietLapChungComponent implements OnInit, OnDestroy {
