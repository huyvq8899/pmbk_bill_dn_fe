...
import { ThietLapChuChimModalComponent } from './thiet-lap-chu-chim-modal/thiet-lap-chu-chim-modal.component';

@Component({
  selector: 'app-tab-thiet-lap-hinh-nen',
  templateUrl: './tab-thiet-lap-hinh-nen.component.html',
  styleUrls: ['./tab-thiet-lap-hinh-nen.component.scss']
})
export class TabThietLapHinhNenComponent implements OnInit, OnDestroy {
  ...
  forkJoin() {
    return forkJoin([
      this.mauHoaDonSerivce.GetBorders(),
