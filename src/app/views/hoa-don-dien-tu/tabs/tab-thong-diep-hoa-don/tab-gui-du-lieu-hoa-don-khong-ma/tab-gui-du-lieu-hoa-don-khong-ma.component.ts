...
@Component({
  selector: 'app-tab-gui-du-lieu-hoa-don-khong-ma',
  templateUrl: './tab-gui-du-lieu-hoa-don-khong-ma.component.html',
  styleUrls: ['./tab-gui-du-lieu-hoa-don-khong-ma.component.scss']
})
export class TabGuiDuLieuHoaDonKhongMaComponent extends TabShortKeyEventHandler implements OnInit {
  dataSelected = null;
  ...
  params: any = {
    ...
    Keyword: '',
    SortKey: '',
    loaiThongDiep: MLTDiep.TDCDLHDKMDCQThue
  };
