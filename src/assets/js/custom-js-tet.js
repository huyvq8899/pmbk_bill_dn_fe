var snowStorm = (function(window, document) {
    ...
    this.snowCharacter = '<img src="assets/hoadao.png" />'; // • = bullet, · is square on some systems etc.
    this.snowStick = false; // Whether or not snow should "stick" at the bottom. When off, will never collect.
    this.targetElement = 'container-animation'; // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
